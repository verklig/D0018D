...
public class BankLogic
{
    ...
    public int createSavingsAccount(String pNo)
    {
        for (Customer customer : customers)
        {
            ...
            if (existingPNo.equals(pNo))
            {
                ...
                Account newAccount = new Account(accountNumber, "Sparkonto", pNo);
    ...
    public boolean withdraw(String pNo, int accountNum, int amount)
    {
        ...
        return false; // Customer not found, account doesn't belong to the customer, or insufficient balance
    }
